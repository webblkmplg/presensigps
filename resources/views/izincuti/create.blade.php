...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Form Data Cuti</div>
        <div class="right"></div>
    </div>
    <!------- * App Header -------->
@endsection
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form method="POST" action="/izincuti/store" id="frmCuti" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <input type="text" id="tgl_cuti_dari" name="tgl_cuti_dari" class="form-control datepicker"
                        placeholder="Dari" autocomplete="off">
                </div>
                <div class="form-group">
                    <input type="text" id="tgl_cuti_sampai" name="tgl_cuti_sampai" class="form-control datepicker"
                ...
                <div class="form-group">
                    <select name="kode_cutii" id="kode_cutii" class="form-control selectmaterialize">
                        <option value="">Pilih Jenis Cuti</option>
                        @foreach ($mastercuti as $c)
                            <option value="{{ $c->kode_cutii }}">{{ $c->nama_cuti}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
