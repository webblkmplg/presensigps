...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Edit Data Cuti</div>
        <div class="right"></div>
    </div>
    <!------- * App Header -------->
@endsection
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form method="POST" action="/izincuti/{{ $datacuti->kode_cuti}}/update" id="frmCuti" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <select name="kode_cutii" id="kode_cutii" class="form-control selectmaterialize">
                        ...
                        @foreach ($mastercuti as $c)
                            <option {{ $datacuti->kode_cutii ? 'selected' : '' }} value="{{ $c->kode_cutii }}">{{ $c->nama_cuti}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
