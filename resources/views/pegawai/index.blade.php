                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" maxlength="18" class="form-control" placeholder="NIP"
                                        name="nip" id="nip">
                                </div>
                            </div>
                        </div>
