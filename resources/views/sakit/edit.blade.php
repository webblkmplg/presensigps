...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Edit Data Cuti Sakit</div>
        <div class="right"></div>
    </div>
    <!------- * App Header -------->
@endsection
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form method="POST" action="/cutisakit/{{$datacuti->kode_cuti}}/update" id="frmCuti" enctype="multipart/form-data">
                @csrf
                ...
                @if ($datacuti->doc_sid != null)
                <div class="row">
                    <div class="col-12">
                        @php
                         $docsid = Storage::url('/uploads/sid/'.$datacuti->doc_sid);   
                        @endphp
