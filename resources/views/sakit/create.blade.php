...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Form Data Cuti Sakit</div>
        <div class="right"></div>
    </div>
    <!------- * App Header -------->
@endsection
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form method="POST" action="/cutisakit/store" id="frmCuti" enctype="multipart/form-data">
                @csrf
                ...
                <div class="custom-file-upload" id="fileUpload1" style="height: 100px !important">
                    ...
                    aria-label="cloud upload outline"></ion-icon>
                                <i>Tap untuk Upload Surat Keterangan Sakit (Optional)</i>
                            </strong>
                        </span>
                    </label>
                </div>
