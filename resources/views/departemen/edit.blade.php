    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->kode_dept }}" class="form-control"
                    placeholder="Kode Unit Kerja" name="kode_dept" id="kode_dept" readonly>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->nama_dept }}" class="form-control"
                    placeholder="Nama Unit Kerja" name="nama_dept" id="nama_dept">
            </div>
        </div>
    </div>
