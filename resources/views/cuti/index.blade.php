                                               ...
                                               <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="/cuti/{{ $d->kode_cutii }}/delete"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/cuti/store" method="POST" id="frmCutii">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="kode_cutii" class="form-control"
                                        placeholder="Kode Cuti" name="kode_cutii">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_cuti" class="form-control"
                                        placeholder="Jenis Cuti" name="nama_cuti" >
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="jml_hari" class="form-control"
                                        placeholder="Jumlah Hari" name="jml_hari" >
                                </div>
                            </div>
                        </div>
...
@push('myscript')
    <script>
        $(function() {
            ...
            $(".edit").click(function() {
                var kode_cutii = $(this).attr('kode_cutii');
                $.ajax({
                    type: 'POST',
                    url: '/cuti/edit',
                    cache: false,
