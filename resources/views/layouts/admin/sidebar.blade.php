    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('presensi/sakitcuti') ? 'active' : '' }}"
                        href="/presensi/sakitcuti">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('presensi/rekap-keterlambatan') ? 'active' : '' }}"
                        href="/presensi/rekap-keterlambatan">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-door-exit"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
